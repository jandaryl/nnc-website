    ...
    <div class="flex flex-col items-center container mx-auto h-auto w-64 bg-grey-lighter rounded-none shadow-md">
      ...
      <div class="inline-flex flex-row h-auto w-auto">
          ...
          <div class='carousel carousel-animated carousel-animate-slide' data-autoplay="true">
            <div class='carousel-container'>
              <div class='carousel-item has-background is-active'>
                <img class="is-background" src="https://i.imgur.com/WUxqN8G.jpg" alt="" width="640" height="310" />
              </div>
              <div class='carousel-item has-background'>
                <img class="is-background" src="https://i.imgur.com/pQ3P49i.jpg" alt="" width="640" height="310" />
              </div>
              <div class='carousel-item has-background'>
                <img class="is-background" src="https://i.imgur.com/eFGlSdv.jpg" alt="" width="640" height="310" />
              </div>
              <div class='carousel-item has-background'>
                <img class="is-background" src="https://i.imgur.com/9ZrUcRr.jpg" alt="" width="640" height="310" />
              </div>
            </div>
        ...
        <div class="inline-flex flex-col h-auto w-auto mt-8">
            ...
            <div class="bg-white h-auto max-auto text-center rounded-lg shadow-lg mb-8 mr-8">
              ...
              <p class="text-md font-mono p-4 tracking-tight">To produce quality ice cream products for the customer and create a good image to the society in terms of product quality.
              </p>
            </div>
      </div>
      </div>
      <div class="inline-flex flex-row h-auto w-auto">
         <div class="bg-white h-auto max-w-lg mr-8 text-center rounded-lg shadow-lg mb-12 ml-8 mt-4">
              ...
              <p class="text-md font-mono p-4 tracking-tight">Gelato De Nacion advocates healthy living by producing the best tasting delicious and healthy ice cream products which are suitable for all ages.
              </p>
         </div>
        <div class="bg-white h-auto max-w-lg text-center rounded-lg shadow-lg mb-12 mr-8 mt-4">
              ...
              <p class="text-md font-mono p-4 tracking-tight">Gelato De Nacion shall become the top producer of the best tasting Ice Cream products in the city and the entire Negros Island.
              </p>
        </div>
      </div>
    ...
    <!-- Start Helper Buttons -->
      <div class="flex flex-row justify-between container mx-auto h-auto w-auto">
         <button class="mt-8 mb-8 bg-green hover:bg-green-dark text-white text-sm font-bold py-2 px-4 h-12 w-24 rounded mb-4">
                    <a class="text-white hover:text-white" href="{{ route('everyday-lechon') }}"><i class="fas fa-arrow-left fa-1x mr-2"></i>Prev</a>
         </button>
         <button class="mt-8 mb-8 bg-green hover:bg-green-dark text-white text-sm font-bold py-2 px-4 h-12 w-24 rounded mb-4">
                    <a class="text-white hover:text-white" href="{{ route('theophilia-flowerets-farm') }}"><i class="fas fa-arrow-right fa-1x mr-2"></i>Next</a>
         </button>
      </div>
      <!-- End Helper Buttons -->
    <!-- End Main Content -->
