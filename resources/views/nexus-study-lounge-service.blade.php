...
<html>
  <head>
    ...
    <title>Nexus Study Lounge Service</title>
    ...
    <!-- Start Service Info -->
      <div class="flex flex-col items-center container mx-auto h-auto w-auto bg-grey-lighter rounded-none shadow-md">
        <div class="inline-flex flex-row items-center h-auto w-auto ml-12 mr-12 mt-4 mb-12">
          <img class="h-48 w-48 rounded-none shadow-lg ml-4 mr-8 mt-4 mb-4 " src="https://i.imgur.com/GhOuQqe.png" alt="Nexus Study Lounge Service Logo">
